...
extension DeveloperToolsSupport.ImageResource {
    ...
    /// The "swift" asset catalog image resource.
    static let swift = DeveloperToolsSupport.ImageResource(name: "swift", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "swift" asset catalog image.
    static var swift: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .swift)
#else
        .init()
...
extension UIKit.UIImage {
    ...
    /// The "swift" asset catalog image.
    static var swift: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .swift)
#else
        .init()
